    ...
    <div className="container px-5 py-24 mx-auto">
      ...
      {data.map((item)=>{
        ...
        <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
          ...
          <Link href={'/checkout'}><button className="flex ml-auto text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded">Buy Now</button>
          </Link>
          </div>
